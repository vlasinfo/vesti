(function() {
    ...
    JSONP.get('http://ua.traffim.com/draw', {id:'81',time:timestamp}, function(data){
        if(document.getElementById('traffim-widget-81') === null) {
            document.getElementById('newsriver-widget-81').innerHTML =   data;
        } else {
            document.getElementById('traffim-widget-81').innerHTML =   data;
        }
    });
})();
