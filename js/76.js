(function() {
    ...
    JSONP.get('http://ua.traffim.com/draw', {id:'76',time:timestamp}, function(data){
        if(document.getElementById('traffim-widget-76') === null) {
            document.getElementById('newsriver-widget-76').innerHTML =   data;
        } else {
            document.getElementById('traffim-widget-76').innerHTML =   data;
        }
    });
})();
